...
import meng.customerservice.easeui.photoview.EasePhotoView;
import meng.customerservice.easeui.utils.EaseLoadLocalBigImgTask;
...
public class EaseShowBigImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        default_res = getIntent().getIntExtra("default_image",
                R.drawable.cs_my_avatar_default_round);
        ...
        if (uri != null && new File(uri.getPath()).exists()) {
            ...
            if (bitmap == null) {
                EaseLoadLocalBigImgTask task = new EaseLoadLocalBigImgTask(this, uri.getPath(),
                        image, loadLocalPb, ImageUtils.SCALE_IMAGE_WIDTH,
    ...
    private void downloadImage(final String remoteFilePath, final Map<String, String> headers) {
            ...
            public void onSuccess() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        bitmap = ImageUtils.decodeScaleImage(localFilePath, screenWidth,
                                screenHeight);
                        if (bitmap == null) {
                            image.setImageResource(default_res);
                        } else {
        ...
        EMClient.getInstance().chatManager().downloadFile(remoteFilePath, tempPath, headers,
                callback);
